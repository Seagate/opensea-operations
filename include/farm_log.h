...
extern "C"
{
    ...
    //
    //! \brief   Description: This function pulls the Seagate Combined FARM log.
    //! This Log is a combination of all
    //!						  FARM Log Subpages.
    //
    //  Entry:
    ...
    //!   transferSizeBytes = OPTIONAL. If set to zero, this is ignored.
    //  Exit:
